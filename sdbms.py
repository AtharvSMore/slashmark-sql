...
class DBHelper():
    def __init__(self):
        self.conn=sqlite3.connect("C:\\Users\\mores\\Downloads\\sdms.db")
...
class Login(QDialog):
    ...
    def handleLogin(self):
        if (self.textName.text() == 'atharv' and
            self.textPass.text() == 'Satara@123'):
            self.accept()
        else:
            QMessageBox.warning(
...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.picLabel.setPixmap(QtGui.QPixmap("C:\\Users\\mores\Downloads\\user.png"))
